(deftheme ample-base "A smooth light theme to pair with ample-dark.")

;; Not a bad idea to define a palette...
(let* ((ample/green "#4A8F30")
       (ample/dark-green "#057F40")
       (ample/light-green-bg "#BBC8A1") ; BBC8A1
       (ample/blue "#4170B3")
       (ample/light-blue "#528FD1")
       (ample/light-blue-bg "#BBB9B1")
       (ample/lighter-blue "#68A5E9")
       (ample/orange "#FF8512")
       (ample/tan "#5D5C01") ; 5D5C01
       (ample/dark-tan "#7D7C00") ; 7D7C21
       (ample/yellow "#787800") ; 787800
  ...
  (custom-theme-set-faces
   `ample-base ;; you must use the same theme name here...
   ...
   `(font-lock-comment-face		((t (:foreground ,ample/red))))
   `(font-lock-comment-delimiter-face	((t (:foreground ,ample/red))))
   `(font-lock-function-name-face	((t (:foreground ,ample/blue))))
   `(font-lock-keyword-face		((t (:foreground ,ample/yellow))))
   `(font-lock-string-face		((t (:foreground ,ample/green))))
   `(font-lock-preprocessor-face	((t (:foreground ,ample/orange))))
   `(font-lock-type-face		((t (:foreground ,ample/fg))))
...
;;;###autoload
(defun ample-base-theme()
  "Apply the ample-base-theme."
  (interactive)
  (load-theme 'ample-base t))


(provide-theme 'ample-base)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; ample-base-theme.el ends here
